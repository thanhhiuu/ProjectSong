...
const coins = {
  ...
  RadioIcon: <RadioIcon style={{ fontSize: '20px' }} />,
  ArrowBackIcon: <ArrowBackIcon />,
  ArrowForwardIcon: <ArrowForwardIcon />,
  SearchIcon: <SearchIcon style={{ fontSize: '26px' }} />,
  LaptopWindowsIcon: <LaptopWindowsIcon style={{ fontSize: '19px' }} />,
  ...
  ShuffleIcon: <ShuffleIcon style={{ fontSize: '22px' }} />,
  PlayCircleOutlineIcon: <PlayCircleOutlineIcon style={{ fontSize: '40px' }} />,
  SkipPreviousIcon: <SkipPreviousIcon style={{ fontSize: '22px' }} />,
  RepeatOneIcon: <RepeatOneIcon style={{ fontSize: '22px' }} />,
  PauseCircleOutlineIcon: (
    <PauseCircleOutlineIcon style={{ fontSize: '40px' }} />
  ),
  ArrowForwardIosIcon: (
    <ArrowForwardIosIcon style={{ height: '16px', width: '16px' }} />
  ),
  PauseIcon: <PauseIcon />,
  VolumeUpIcon: <VolumeUpIcon style={{ fontSize: '24px', color: '#444444' }} />,
  VolumeOffIcon: (
    <VolumeOffIcon style={{ fontSize: '24px', color: '#444444' }} />
  ),
